...
'text'=>"
 - مـرحـبا بك عزيـزي في هذا البوت
انت المطور الأساسي هنا اختر من 
الأسفل للتحكم بالبوت 💖🌹   
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
",
'reply_to_message_id'=>$message->message_id,
'disable_web_page_preview'=> true ,
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>'اشتراك اجباري','callback_data'=>'bbb'],['text'=>'بعدين 😐','callback_data'=>'nn']],
[['text'=>'اذاعة','callback_data'=>'a1'],['text'=>'مادري 😹','callback_data'=>'rr']],
[['text'=>'المطور','url'=>'T.me/p6xxx'],['text'=>"ستوريات 🖤",'url'=>'T.me/jeccc']],
]
])]);}
...
bot('editMessageText',[
 ...
 'message_id'=>$message_id,
 'text'=>"
 قم بأختيار إحدى القوائم 💖😐
",
'disable_web_page_preview'=> true ,
 'parse_mode'=>"Markdown",
 'reply_markup'=>json_encode([
 'inline_keyboard'=>[
[['text'=>'القائمة الاولى','callback_data'=>'b1'],['text'=>'القائمة الثانية','callback_data'=>'b2']],
[['text'=>"الصفحه الرئيسيه",'callback_data'=>'hom']],]])]);}
